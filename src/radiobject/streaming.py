...
class StreamingWriter:
    ...
    def __init__(
        ...
        self._obs_rows: list[dict[str, Any]] = []
    ...
    def write_volume(
        ...
        **attrs: Any,
        ...
        Args:
            data: Volume data array (must match shape)
    ...
    def write_batch(
        self, volumes: list[tuple[npt.NDArray[np.floating], str, str, dict[str, Any]]]
    ) -> None:
